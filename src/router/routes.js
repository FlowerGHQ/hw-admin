...
const routes = [{
    ...
    { // 维修单
        ...
        children: [
            ...
            },
            {
                ...
                name: 'RepairEdit',
                component: () =>
                    import ('@/views/repair/repair-edit.vue'),
                hidden: true,
                meta: {
                    title: '维修单编辑',
            ...
            },
            {
                ...
                name: 'RepairDetail',
                component: () =>
                    import ('@/views/repair/repair-detail.vue'),
                hidden: true,
                meta: {
                    title: '维修单详情',
                    parent: '/repair/repair-list',
            ...
            },
            {
                ...
                name: 'RepairInvoice',
                component: () =>
                    import ('@/views/repair/repair-invoice.vue'),
                hidden: true,
                meta: {
                    title: '维修单结算',
                    parent: '/repair/repair-list',
    ...
    { // 分销商管理 - 平台端
        ...
        children: [{
            ...
            component: () =>
                import ('@/views/distributor/distributor-list.vue'),
            meta: {
                title: '分销商列表',
                roles: [LOGIN_TYPE.ADMIN],
            }
        },
            {
                ...
                component: () =>
                    import ('@/views/distributor/distributor-edit.vue'),
                hidden: true,
                meta: {
                    title: '分销商编辑',
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/distributor/distributor-detail.vue'),
                hidden: true,
                meta: {
                    title: '分销商详情',
                    parent: '/distributor/distributor-list',
    ...
    { // 零售商管理 - 平台端 分销商端
        ...
        children: [{
            ...
            name: 'AgentList',
            component: () =>
                import ('@/views/agent/agent-list.vue'),
            meta: {
                title: '零售商列表',
                roles: [LOGIN_TYPE.ADMIN, LOGIN_TYPE.DISTRIBUTOR],
            }
        },
            {
                ...
                name: 'AgentEdit',
                component: () =>
                    import ('@/views/agent/agent-edit.vue'),
                hidden: true,
                meta: {
                    title: '零售商编辑',
            ...
            },
            {
                ...
                name: 'AgentDetail',
                component: () =>
                    import ('@/views/agent/agent-detail.vue'),
                hidden: true,
                meta: {
                    title: '零售商详情',
                    parent: '/agent/agent-list',
    ...
    { // 门店管理 - 平台端&零售商端
        ...
        children: [{
            ...
            name: 'StoreList',
            component: () =>
                import ('@/views/store/store-list.vue'),
            meta: {
                title: '门店列表',
            }
        },
            {
                ...
                name: 'StoreEdit',
                component: () =>
                    import ('@/views/store/store-edit.vue'),
                hidden: true,
                meta: {
                    title: '门店编辑',
            ...
            },
            {
                ...
                name: 'StoreDetail',
                component: () =>
                    import ('@/views/store/store-detail.vue'),
                hidden: true,
                meta: {
                    title: '门店详情',
                    parent: '/store/store-list',
    ...
    { // 仓库
        ...
        children: [{
            ...
            name: 'WarehouseList',
            component: () =>
                import ('@/views/warehouse/warehouse-list.vue'),
            meta: {
                title: '仓库管理',
                is_sub_menu: true
            }
        },
            {
                ...
                name: 'WarehouseEdit',
                component: () =>
                    import ('@/views/warehouse/warehouse-edit.vue'),
                hidden: true,
                meta: {
                    title: '仓库编辑',
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/warehouse/warehouse-detail.vue'),
                hidden: true,
                meta: {
                    title: '仓库详情',
                    parent: '/warehouse/warehouse-list',
            ...
            },
            {
                ...
                name: 'InvoiceEdit',
                component: () =>
                    import ('@/views/warehouse/invoice-edit.vue'),
                hidden: true,
                meta: {
                    title: '出入库编辑',
            ...
            },
            {
                ...
                name: 'InvoiceDetail',
                component: () =>
                    import ('@/views/warehouse/invoice-detail.vue'),
                hidden: true,
                meta: {
                    title: '出入库详情',
                    parent: '/invoice/invoice-list',
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/warehouse/transfer-order-edit.vue'),
                hidden: true,
                meta: {
                    title: '调货单编辑',
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/warehouse/transfer-order-detail.vue'),
                hidden: true,
                meta: {
                    title: '调货单详情',
                    parent: '/transfer/transfer-order-list',
        ...
        children: [
            {
                ...
                name: 'EntityList',
                component: () =>
                    import ('@/views/entity/entity-list.vue'),
                meta: {
                    title: '车架列表',
                    roles: [LOGIN_TYPE.ADMIN],
                    is_sub_menu: true
        ...
        children: [
            {
                ...
                name: 'ItemList',
                component: () =>
                    import ('@/views/item/item-list.vue'),
                meta: {
                    title: '商品列表',
                    roles: [LOGIN_TYPE.ADMIN],
                    is_sub_menu: true
            ...
            },
            {
                ...
                name: 'ItemEdit',
                component: () =>
                    import ('@/views/item/item-edit.vue'),
                hidden: true,
                meta: {
                    title: '商品编辑',
                    roles: [LOGIN_TYPE.ADMIN],
            ...
            },
            {
                ...
                name: 'ItemDetail',
                component: () =>
                    import ('@/views/item/item-detail.vue'),
                hidden: true,
                meta: {
                    title: '商品详情',
                    roles: [LOGIN_TYPE.ADMIN],
            ...
            },
            {
                ...
                name: 'SalesList',
                component: () =>
                    import ('@/views/item/sales-area-list.vue'),
                meta: {
                    title: '销售区域',
                    roles: [LOGIN_TYPE.ADMIN],
                    is_sub_menu: true
            ...
            },
            {
                ...
                name: 'SalesEdit',
                component: () =>
                    import ('@/views/item/sales-area-edit.vue'),
                hidden: true,
                meta: {
                    title: '区域编辑',
                    roles: [LOGIN_TYPE.ADMIN],
            ...
            },
            {
                ...
                name: 'ItemCategory',
                component: () =>
                    import ('@/views/item/item-category.vue'),
                meta: {
                    roles: [LOGIN_TYPE.ADMIN],
                    title: '商品分类',
                    is_sub_menu: true,
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/item/item-category-config.vue'),
                hidden: true,
                meta: {
                    roles: [LOGIN_TYPE.ADMIN],
                    title: '商品分类配置',
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/purchase/purchase-order-list.vue'),
                meta: {
        ...
        children: [
            {
                ...
                component: () =>
                    import ('@/views/purchase/item-list.vue'),
                meta: {
                    title: '采购',
                    roles: [LOGIN_TYPE.AGENT, LOGIN_TYPE.STORE, LOGIN_TYPE.DISTRIBUTOR],
                    is_sub_menu: true
            ...
            },
            {
                ...
                name: 'ItemDisplay',
                component: () =>
                    import ('@/views/purchase/item-display.vue'),
                hidden: true,
                meta: {
                    title: '商品详情',
                    roles: [LOGIN_TYPE.AGENT, LOGIN_TYPE.STORE, LOGIN_TYPE.DISTRIBUTOR],
            ...
            },
            {
                ...
                name: 'ItemCollect',
                component: () =>
                    import ('@/views/purchase/item-collect.vue'),
                meta: {
                    roles: [LOGIN_TYPE.AGENT, LOGIN_TYPE.STORE, LOGIN_TYPE.DISTRIBUTOR],
                    title: '购物车',
                    is_sub_menu: true,
            ...
            },
            {
                ...
                name: 'ItemSettle',
                component: () =>
                    import ('@/views/purchase/item-settle.vue'),
                hidden: true,
                meta: {
                    roles: [LOGIN_TYPE.AGENT, LOGIN_TYPE.STORE, LOGIN_TYPE.DISTRIBUTOR],
                    title: '结算',
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/purchase/purchase-order-detail.vue'),
                hidden: true,
                meta: {
                    roles: [LOGIN_TYPE.AGENT, LOGIN_TYPE.STORE, LOGIN_TYPE.ADMIN, LOGIN_TYPE.DISTRIBUTOR],
                    title: '采购订单详情',
    ...
    { // 退款管理
        ...
        children: [{
            ...
            component: () =>
                import ('@/views/refund/refund-list.vue'),
            meta: {
                title: '退款申请',
                roles: [LOGIN_TYPE.AGENT, LOGIN_TYPE.DISTRIBUTOR, LOGIN_TYPE.STORE],
                // is_sub_menu: true,
            ...
            },
            {
                ...
                name: 'refundCreate',
                component: () =>
                    import ('@/views/refund/refund-create.vue'),
                hidden: true,
                meta: {
                    title: '申请退款',
    ...
    { // 客户管理
        ...
        children: [{
            ...
            name: 'CustomerList',
            component: () =>
                import ('@/views/customer/customer-list.vue'),
            meta: {
                title: '客户列表',
            }
        },
            {
                ...
                name: 'CustomerEdit',
                component: () =>
                    import ('@/views/customer/customer-edit.vue'),
                hidden: true,
                meta: {
                    title: '新建客户',
    ...
    { // 角色管理
        ...
        children: [{
            ...
            name: 'RoleList',
            component: () =>
                import ('@/views/authority/auth-role-list.vue'),
            meta: {
                title: '角色管理',
            }
        },
            {
                ...
                name: 'RoleEdit',
                component: () =>
                    import ('@/views/authority/auth-role-edit.vue'),
                hidden: true,
                meta: {
                    title: '角色编辑',
    ...
    { // 系统管理
        ...
        children: [{
            ...
            name: 'SystemFileList',
            component: () =>
                import ('@/views/system/system-file-list.vue'),
            meta: {
                title: '系统附件',
                is_sub_menu: true,
            }
        },
            {
                ...
                name: 'SystemFileEdit',
                component: () =>
                    import ('@/views/system/system-file-edit.vue'),
                hidden: true,
                meta: {
                    title: '附件编辑',
            ...
            },
            {
                ...
                name: 'NoticeList',
                component: () =>
                    import ('@/views/system/notice-list.vue'),
                meta: {
                    title: '消息列表',
                    is_sub_menu: true,
                }
            },
            {
                ...
                name: 'NoticeEdit',
                component: () =>
                    import ('@/views/system/notice-edit.vue'),
                hidden: true,
                meta: {
                    title: '新增消息',
            ...
            },
            {
                ...
                name: 'NoticeDetail',
                component: () =>
                    import ('@/views/system/notice-detail.vue'),
                hidden: true,
                meta: {
                    title: '消息详情',
                    parent: '/system/notice-list',
            ...
            },
            {
                ...
                name: 'AllotOrgAuth',
                component: () =>
                    import ('@/views/system/allot-org-auth.vue'),
                meta: {
                    title: '组织权限管理',
                    is_sub_menu: true,
                    roles: [LOGIN_TYPE.ADMIN],

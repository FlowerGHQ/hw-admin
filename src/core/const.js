...
let Const = {
  ...
  REPAIR: {
    ...
    STATUS_MAP: {
      ...
      60: {
        ...
        color: "orange",
        zh: "已结算待审核",
        en: "Settled accounts and awaiting audit",
      },
      70: {
        key: 70,
        color: "orange",
  ...
  FEEDBACK: {
    ...
    STATUS_MAP: {
      ...
      300: {
        ...
        color: "purple",
        zh: "等待质量审核",
        en: "Waiting for quality audit",
      },
      310: {
        key: 300,
        color: "purple",
        zh: "等待修改反馈",
        en: "Waiting for modification feedback",
      },
      400: {
        key: 400,
        color: "purple",
  ...
  ACTION_LOG: {
    ...
    TYPE_MAP: {
      ...
      202: {
        key: 202,
        zh: "维修单信息完善/修改",
        en: "Information improvement/modification",
      },
      ...
      611: {
        key: 601,
        zh: "反馈单平台审核通过",
        en: "Feedback single platform approved",
      },
      612: {
        key: 601,
        zh: "反馈单平台审核不通过",
        en: "Feedback single platform review failed",
      },
      613: {
        key: 601,
        zh: "反馈单平台审核后关闭",
        en: "Feedback single platform will be closed after review",
      },
      614: {
        key: 601,
        zh: "反馈单平台审核后修改",
      ...
      621: {
        key: 601,
        zh: "反馈单平台质量审核通过",
        en: "Feedback single platform quality review passed",
      },
      622: {
        key: 601,
        zh: "反馈单平台质量审核不通过",
        en: "Feedback single platform quality review failed",
      },
      623: {
        key: 601,
        zh: "反馈单平台质量审核后关闭",
      ...
      631: {
        key: 601,
        zh: "反馈单平台反馈",
        en: "Feedback Single Platform Feedback",
      },
      632: {
        key: 601,
        zh: "反馈单平台反馈审核通过",
        en: "Feedback single platform feedback review passed",
      },
      633: {
        key: 601,
        zh: "反馈单平台质量审核不通过",
      ...
      634: {
        key: 601,
        zh: "反馈单平台反馈修改",
        en: "Feedback Single Platform Feedback Modification",
      },
      650: {
        key: 601,
        zh: "反馈单平台反馈关闭",
        en: "Feedback Single Platform Feedback Close",
      },
  ...
  PURCHASE: {
    ...
    Receive_goods: {
      ...
      360: {
        ...
        color: "green",
        zh: "预计10-12天工作日",
        en: "Expected to be completed in 10-12 days",
      },
    },
    // 审核状态
    examine_status: {
  ...
  AUTH_LIST_TEMP: [
    ...
    { list: [], select: [], key: "transfer", name: "调货单" },
    {
      list: [],
      select: [],
      key: "warehouse-transfer-order",
      name: "仓库调货单",
    },
    {
      list: [],
      select: [],
      key: "material-purchase-order",
      name: "物料采购单",
    },
  ...
  STOCK_RECORD: {
    ...
    STATUS_MAP: {
      ...
      20: {
        key: 30,
        zh: "财务审核通过",
        en: "Financial review passed",
        color: "purple",
      },
      30: {
        key: 20,
        zh: "仓库审核通过",
        en: "Admin review passed",
        color: "blue",
      },
    ...
    SOURCE_TYPE_ADMIN_MAP: {
      ...
      60: {
        key: 60,
        zh: "物料采购单",
        en: "Material purchase order",
        color: "yellow",
      },
      70: {
        key: 70,
        zh: "仓库调货单",
        en: "Warehouse transfer order",
        color: "blue",
      },
    },
    SOURCE_TYPE_MAP: {
  ...
  REFUND: {
    ...
    TYPE_MAP: {
      100: {
        key: 100,
        zh: "零售商申请退款",
        en: "Retailer applies for refund",
        value: 100,
      },
      110: {
        key: 110,
        zh: "分销商申请退款",
        en: "Distributor applies for refund",
        value: 110,
      },
      120: {
        key: 120,
        zh: "门店申请退款",
        en: "Store application for refund",
        value: 120,
      },
      200: {
        key: 200,
        zh: "后台主动退款",
        en: "Backstage active refund",
        value: 200,
      },
    },
    STATUS: {
  ...
  CRM_CUSTOMER: {
    ...
    PURCHASE_INTENT_MAP: {
      10: {
        key: 10,
        zh: "购买意向低",
        en: "Low Purchase Intention",
        value: 10,
      },
      20: {
        key: 20,
        zh: "购买意向中",
        en: "Moderate Purchase Intention",
        value: 20,
      },
      30: {
        key: 30,
    ...
    TEST_DRIVE_INTENT_MAP: {
      10: {
        key: 10,
        zh: "试驾意向低",
        en: "Low Test Drive Intention",
        value: 10,
      },
      20: {
        key: 20,
        zh: "试驾意向中",
        en: "Moderate Test Drive Intention",
        value: 20,
      },
      30: {
        key: 30,
        zh: "试驾意向高",
        en: "High Test Drive Intention",
        value: 30,
      },
      40: {
        key: 40,
        zh: "预约试驾",
        en: "Make An Appointment To Test Drive",
        value: 40,
      },
  ...
  CRM_ORDER: {
    ...
    PAID_MONEY_PROGRESS_MAP: {
      1: {
        key: 1,
        zh: "回款进度 0%-20%",
        en: "Payment Collection Progress 0% - 20%",
        value: 1,
      },
      2: {
        key: 2,
        zh: "回款进度 20%-40%",
        en: "Payment Collection Progress 20% - 40%",
        value: 2,
      },
      3: {
        key: 3,
        zh: "回款进度 40%-60%",
        en: "Payment Collection Progress 40% - 60%",
        value: 3,
      },
      4: {
        key: 4,
        zh: "回款进度 60%-80%",
        en: "Payment Collection Progress 60% - 80%",
        value: 4,
      },
      5: {
        key: 5,
        zh: "回款进度 80%-100%",
        en: "Payment Collection Progress 80% - 100%",
        value: 5,
      },
    },
    WhetherNot: {
  ...
  CRM_TRACK_RECORD: {
    ...
    CHINA_INTENT: {
      ...
      30: {
        ...
        zh: "高意向",
        value: 30,
        con: "完成产品体验并保持购买意向，14天内能决策",
      },
      40: {
        key: 40,
        zh: "Hot",
        value: 40,
        con: "主动提出支付意向金，3天内能做出决策",
      },
    },
    TARGET_TYPE: {
      CUSTOMER: 1,
  ...
  CRM_BO: {
    ...
    LOST_REASON_MAP: {
      ...
      30: {
        key: 30,
        zh: "客户关系原因",
        en: "Customer Relationship Reasons",
        value: 30,
      },
      40: { key: 40, zh: "其他", en: "Other", value: 40 },
    },
  ...
  CRM_ACTION_RECORD: {
    ...
    TYPE_MAP: {
      ...
      1005: {
        key: 1005,
        zh: "新建回款单",
        en: "CREATE_ORDER_INCOME",
        value: 1005,
      },
      1006: {
        key: 1006,
        zh: "删除回款单",
        en: "DELETE_ORDER_INCOME",
        value: 1006,
      },
  ...
  CRM_TEST_DRIVE: {
    ...
    GREEN_ENERGY_UNDERSTAND_MAP: {
      10: {
        key: 10,
        zh: "看好新能源前景",
        en: "We are optimistic about the prospects of new energy",
      },
      20: {
        key: 20,
        zh: "对新能源了解较多",
        en: "I know more about new energy",
      },
      30: {
        key: 30,
        zh: "对新能源了解较浅",
        en: "Shallow understanding of new energy",
      },
    ...
    ELECTRIC_TWO_WHEELER_UNDERSTAND_MAP: {
      10: {
        key: 10,
        zh: "了解整车架构",
        en: "Understand the vehicle architecture",
      },
  ...
  TEST: {
    ...
    TYPE_MAP: {
      10001: {
        value: 10001,
        key: "t.test_case.bms_plug_in_machine",
        text: "BMS外挂整机测试",
      },
      26003: {
        value: 26003,
        key: "t.test_case.lierda_vcu_test",
        text: "利尔达VCU测试",
      },
    },

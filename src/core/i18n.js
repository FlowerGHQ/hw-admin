...
const messages = {
    ...
    en: {
	    ...
	    crm_c: {
		    ...
		    company_size: 'scale of company',
		    company_license_id: 'business license',
		    track_status: 'Follow up the state',
		    add: 'Adding a Contact',
		    add_follow_records:'Add follow-up Records',
		    edit: 'Modifying a Contact',
		    create_user: 'founder',
		    create_time: 'Creation time',
		    update_user: 'modifier',
		    update_time: 'Modify the time',
		    summary_information:"data",
		    related: 'related',
		    obtain: 'get',
		    distribute: 'distribute',
		    delete: 'delete',
		    transfer: 'Hand over',
		    return_pool: 'send back',
		    sure_return_pool: 'Are you sure you want to return the account?',
		    return_pool_success: 'Returned to the successful',
		    sure_obtain: 'Are you sure you want to get the account?',
		    obtain_success: 'Get the success',
		    distribute_customer: 'Distribution of customers',
		    select: 'Please select',
		    team_members: 'The team members',
		    dynamic: 'dynamic',
		    new_pool_c: 'New open sea customers',
		    crm_dict_id: 'client source',
		    distribute_success: 'Distribution of success',
		    order_success_count: 'Into a single number',
		    order_success_price: 'The total amount of the order',
	    ...
	    crm_t: {
		    ...
		    add_track_record: 'Write to follow up',
		    type: 'Follow up way',
		    content: 'Content records',
		    images: 'Content images',
		    file: 'Attachment',
		    track_time: 'Follow up on time',
		    next_track_time: 'Next follow-up time',
		    intent: 'Degree of interest',
		    contact_customer:'Contact',
		    operator: 'Follow up people',
		    next_track_plan: 'Next follow-up Plan',
		    track_record_null: 'No follow-up records yet',
		    contact_customer_id: 'Contact',
        ...
        crm_b: {
		    ...
		    estimated_deal_time: 'Estimated Statement Date',
		    money: 'Amount of business opportunity',
	    ...
	    crm_o: {
		    ...
		    belone_customer: 'Own client',
		    contract_no: 'Contract Number',
		    signing_date: 'Contract date',
		    seller_signatory: 'Our signatory',
		    ...
		    whole_discount: 'Whole order discount',
		    other_fee: 'Other fee',
		    discounted: 'Discounted price',
		    total_price:'Total product amount',
		    discount_rate:'The whole single discount',
		    discount_amount:'Discount amount',
		    other_cost:'Other fees',
		    create_order: 'Save and create the order',
		    approval_process: 'Approval process',
		    add_reviewer: 'Add Reviewer',
		    audit_list: 'List of pending contracts',
		    income_money: 'Has the receivable',
		    refunded_amount: 'Have a refund',
	    },
	    crm_oi: {
		    ...
		    uid: 'Collection slip No',
		    status: 'Payment collection form status',
		    money: 'Collection amount',
		    date: 'Payment collection date',
		    type: 'Collection type',
		    payment_type: 'Payment method',
		    create_user: 'Created by',
		    belong_order: 'Attributable contract order',
		    remark: 'remark',
        ...
        crm_d: {
		    ...
		    name: 'Name of test drive order',
		    save: 'New test drive order',
		    edit: 'Modify the test drive order',
		    detail: 'Details of test drive order',
		    customer_information: 'client information',
		    drive_information: 'client information',
		    user_portrait: 'User portrait',
		    crm_dict_id: 'Test drive cars',
            test_drive_time: 'Test drive time',
		    channel: 'Booking channels',
		    status: 'state',
		    dept_id: 'store',
	    },
        crm_c_p: {
		    buy_type:'Shopping way',
		    rental_demand:'Rental demand',
		    country:'Resident city - Country',
		    province:'Resident City - Province',
		    city:'Resident city',
		    country_en:'Resident City - English name of country',
		    province_en:'Resident City - English name of province',
		    city_en	:'Resident City - English name of city',
		    travel_range:'Travel range',
		    other_brand_model:'Other brand models',
		    park_and_charging_pile	:'Parking space & charging pile situation',
		    family_member:'Family member',
		    green_car_owner	:'New energy owners',
		    driver_license	:'Driving school',
		    ride_exp	:'Riding experience',
		    moto_exp	:'The tour experience',
		    moto_tour_intention	:'The brigade intention',
		    pay_attention_to	:'Pay attention to the direction',
		    green_energy_understand	:'New energy awareness',
		    electric_two_wheeler_understand	:'Electric two-wheel awareness',
		    pre_order_car_type: 'Investment intention model',
		    pre_order_city: 'Leave a capital city',
		    pre_order_time: 'For information and time',
	    },
	    crm_refund: {
		    list: 'Refund list',
		    save: "Save the refund form",
		    type: 'Refund Type',
		    money: 'Amount of this refund',
		    remark: 'Refund Instructions',
		    refund_record: 'Refund record',
		    refunded: 'Refunded amount',
		    total_amount: 'Total order amount',
		    refunded_amount: 'Returned amount',
		    time: 'Refund time',
	    },
	    crm_r: {
	    ...
	    crm_set: {
		    ...
		    name_en: 'English name',
		    index: 'Sort No',
		    list: 'Data dictionary management',
		    save: 'newly added',
		    edit: 'edit',
		    term: 'Entry',
        ...
        crm_dash: {
            ...
            fol_statistics:'Follow up statistics',
            business_analysis:'Business analysis',
            results_list:'Results list',
            purchase_intention:'client purchase Intention',
            test_drive_intention:'client test drive intention',
		    new_customer_count: 'New client',
		    new_contact_count: 'Adding a Contact',
		    new_order_count: 'The new contract',
		    new_bo_count: 'New business opportunities',
		    win_bo_count: 'To win a single number',
		    new_test_driver_count: 'New test drive order',
		    track_count: 'Write follow-up times',
		    call_count: 'Number of calls',
		    visit_count: 'Number of home visits',
		    pool_count: 'Follow up the number of high seas client',
		    customer_count: 'Follow up with personal clients',
		    bo_count: 'Follow up business opportunities',
	    },

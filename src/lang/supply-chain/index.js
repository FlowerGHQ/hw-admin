export default {
  ...
  en: {
    ...
    // 请上传1张2M内的彩色照片或者彩色扫描件或者加盖公章鲜章的复印件
    upload_photos:
      "Please upload 1 color photo or color scan or copy with official seal within 2M",
    // 注册资本
    ...
    // 环评证书
    environmental_assessment_certificate:
    ...
    // 法定代表人必须为纯文本
    legal_representative_must_be_pure_text:
      "Legal Representative Must Be Pure Text",
    // 请输入开户名
    ...
    data_submitted_please_wait_for_review:
      "Data submitted, please wait for review",
    before_the_audit_is_completed_you_can_always_supplement_the_data:

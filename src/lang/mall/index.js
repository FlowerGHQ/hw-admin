export default {
    ...
    en: {
        ...
        need_permission:
            'The current account is not equipped with permissions. Please contact the administrator to enable permissions',
        scan_successful: 'Scan Successful',
        step_one_title:
            'Please Fill In The Recharge Amount First And Transfer The Corresponding Amount To The Receiving Account',
        step_two_title: 'Submit Payment Voucher',
        next_step: 'Next',
        previous_step: 'Back',
        submit_success: 'Submission Successful',
        recharge_progress_pre:
            'The estimated arrival time is 3-5 days, please be patient. The result will be sent to you via email, please check your email carefully. Can also enter',
        ...
        order_reminder_content:
            'The credit balance is insufficient and the order cannot be submitted. Please contact sales staff for processing.',

      ...
      <div class="form-block ">
        ...
        <div class="form-content">
          ...
          <div class="form-item">
            ...
            <div class="value">
              <a-input-number
                v-model:value="all_charge_pile_count"
                disabled
                style="width: 100%"
              />
            </div>
          ...
          <div class="form-item">
            ...
            <div class="value">
              <a-input
                v-model:value="form.localtion.longitude"
                :placeholder="$t('def.input')"
              />
            </div>
          </div>
          ...
          <div class="form-item">
            ...
            <div class="value">
              <a-input
                v-model:value="form.localtion.latitude"
                :placeholder="$t('def.input')"
              />
            </div>
          </div>
...
export default {
  ...
  computed: {
    ...
    all_charge_pile_count() {
      return (
        this.form.ground_charge_pile_count +
        this.form.underground_charge_pile_count
      );
    },
    // 总车位数
    all_park_count() {
  ...
  methods: {
    ...
    handelSave() {
      ...
      if (this.trackRecordForm.image_attachment_list.length) {
        form.logo = JSON.stringify(
          this.trackRecordForm.image_attachment_list[0]
        );
      ...
      Core.Api.RETAIL.storeDetail({
        id: this.form.id,
          ...
          d.open_time = d.open_time
            ? dayjs.unix(d.open_time).format("YYYY-MM-DD")
            : undefined;

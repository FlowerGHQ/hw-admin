        ...
        <div class="d-content">
          ...
          <a-row class="row-detail">
            ...
            <a-col :xs="24" :sm="12" :xl="6" :xxl="6" class="row-item m-t-16">
              <span class="key" style="text-align: left"
                >{{ $t("crm_st.longitude") }}：</span
              >
              <span class="value">
            ...
            <a-col :xs="24" :sm="12" :xl="18" :xxl="6" class="row-item m-t-16">
              <span class="key" style="width: 80px; text-align: left"
                >{{ $t("crm_st.latitude") }}：</span
              >
              <span class="value">
            ...
            <a-col :xs="24" :sm="12" :xl="6" :xxl="6" class="row-item m-t-16">
              ...
              <span class="value">
                {{
                  form.ground_charge_pile_count +
                  form.underground_charge_pile_count
                }}
              </span>
            </a-col>
            <!-- 充电桩数 -->

<template>
    <div>
        <div class="value">
            <a-upload :file-list="upload.detailList" name="file" accept="image/*" :headers="upload.headers"
                :data="upload.data" :action="upload.action" :before-upload="handleImgCheck" :showUploadList="false"

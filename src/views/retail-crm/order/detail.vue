<template>
    <div class="order-detail" >
        <div class="d-top">
            ...
            <div class="container">            
                <div class="d-img">
                    <img class="img" src="https://img0.baidu.com/it/u=2220978215,658189084&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=768" alt="">
                </div>
                <div class="d-content">
                    <a-row class="all-msg">
                          <div class="order-msg">
            ...
            <div class="commodity-msg">
                ...
                <div class="commodity-content">
                    <div class="content-left">
                        <img class="img" src="https://img2.baidu.com/it/u=3765245611,3014132835&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500" alt="">
                    </div>
    ...
    <a-modal 
        ...
        @ok="refundHandleOk">
        <template #footer>
            <a-button  @click="refundHandleCancel">
                取消
            </a-button>  

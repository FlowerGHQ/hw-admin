  ...
  <div id="file-list" class="list-container">
    <div class="left">
      <div class="title-container">
        <div class="title-area">{{ $t("f.file") }}</div>
      </div>
      ...
      <div class="file-box">
        ...
        <div class="directory">
          <div class="title">{{ $t("retail.directory") }}</div>
          <a-button type="primary" ghost>{{
            $t("retail.add_directory")
          }}</a-button>
        </div>
        ...
        <div class="file-explore-box">
          <div
            ...
            :key="fileItem.id"
            @contextmenu.prevent="
              showContextMenu(fileItem, index, $event, 'file')
            "
            @click="fileItemSelect(fileItem.id)"
          >
            <div class="file-left">
              <img
                src="../../../assets/images/retail/manual.png"
                class="file-img"
                alt=""
              />
              <a-tooltip placement="top" :title="fileItem.fileName">
                <div class="name-box" v-if="!fileItem.isInputName">
                  {{ fileItem.fileName }}
                </div>
                <a-input
                  v-else
    ...
    <div style="flex: 1">
      ...
      <div class="file-content">
        <div
          ...
          @contextmenu.prevent="
            showContextMenu(contentItem, index, $event, 'content')
          "
        >
          <img
            class="content-item-img"
            src="../../../assets/images/retail/book.png"
            alt=""
          />

          <a-tooltip placement="top" :title="contentItem.fileName">
            <div class="name-box" v-if="!contentItem.isInputName">
    ...
    <div
      ...
      :style="{
        top: contextMenuY - 80 + 'px',
        left: contextMenuX - 220 + 'px',
      }"
    >

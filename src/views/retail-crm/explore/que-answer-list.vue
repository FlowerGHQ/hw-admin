<template>
    <div id="answerList">
        <div class="list-container">
            <div class="title-container">
                ...
                <div class="btns-area" v-if="$auth('customer.save')">
                    ...
                    <!--创建问题解答-->
                    <a-button type="primary" @click="handleCreateQuestion">
                        创建问题解答
                    </a-button>
                </div>
            </div>
            <div class="search-container">
                <a-row class="search-area">
                    <a-col :xs='24' :sm='24' :xl="8" :xxl='6' class="search-item">
                        <div class="value">
                            <a-input placeholder="搜索区域" v-model:value="searchForm.area"
        ...
        <a-modal v-model:visible="modalShow" :title="current_id ? '问题解答' : '创建问题解答'" class="edit-modal" :after-close="handleModalClose">
            <div class="modal-form-item">
                <div class="modal-key">问题</div>
                <div class="modal-value">
                    <a-textarea v-model:value="form.question" :auto-size="{ minRows: 6, maxRows: 6 }" placeholder="请输入" />
                </div>
            </div>
            <div class="modal-form-item">
                <div class="modal-key">答案</div>
                <div class="modal-value">
                    <a-textarea v-model:value="form.answer" :auto-size="{ minRows: 6, maxRows: 6 }" placeholder="请输入" />
                </div>
            </div>
            <template #footer>

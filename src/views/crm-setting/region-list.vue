    ...
    <div id="CrmRegion">
        ...
        <template class="modal-container">
            <a-modal
                ...
                :title="editForm.id ? $t('crm_region.edit') : $t('crm_region.new')"
                    ...
                    <div class="form-item required">
                        ...
                        <div class="value">
                            <a-input
                                ...
                                :placeholder="$t('def.input') + $t('crm_region.name')"
                            />
                        </div>
                    </div>
                    <div class="form-item required">
...
export default {
    ...
    methods: {
        ...
        // 编辑与新增子类
        handleModalShow(
            { parent_id = 0, id, name, admin_user_id, admin_user_name, remark },
            node = null,
            parent = null,
        ) {
            this.editForm = {

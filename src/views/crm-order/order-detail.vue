            ...
            <a-row class="desc-detail">
              ...
              <a-col :xs="24" :sm="24" :lg="24" class="detail-item">
                ...
                <span class="value">
                  <LabelList
                    :targetId="id"
                    :targetType="Core.Const.CRM_LABEL.CATEGORY.ORDER" />
                </span>
              </a-col>
            </a-row>
          </div>
    ...
    <a-modal
      ...
      <div class="modal-content">
        ...
        <div class="form-item">
          ...
          <div class="value">
            <a-input
              v-model:value="addressForm.address_line_1"
        ...
        <div class="form-item">
          ...
          <div class="value">
            <a-input
              v-model:value="addressForm.admin_area_2"
              :placeholder="$t(/*请输入*/ 'def.input')" />
          </div>
        </div>
        <!-- 州 -->
        <div class="form-item">
          ...
          <div class="value">
            <a-input
              v-model:value="addressForm.admin_area_1"
              :placeholder="$t(/*请输入*/ 'def.input')" />
          </div>
        </div>
        <!-- 邮编 -->
        <div class="form-item">
          ...
          <div class="value">
            <a-input
              v-model:value="addressForm.postal_code"
              :placeholder="$t(/*请输入*/ 'def.input')" />
          </div>
        </div>
        <!-- 国家 -->
        <div class="form-item">
          ...
          <div class="value">
            <a-input
              v-model:value="addressForm.country_code"
              :placeholder="$t(/*请输入*/ 'def.input')" />
          </div>
        </div>
      </div>
      <template #footer>
        <a-button type="primary" @click="handleAddressEditConfirm">{{
          $t(/*确定*/ "def.ok")
        }}</a-button>
    ...
    getOrderDetail() {
      ...
      Core.Api.CRMOrder.detail({
        ...
        .then((res) => {
          ...
          this.detail.payAddress = this.handleRemoveExtraCommas(
            this.detail.payAddress
          );
          ...
          this.auditUserList.forEach((item) => {
            if (
              item.audit_status ===
              Core.Const.CRM_AUDIT_PROCESS.AUDIT_STATUS.WAIT_AUDIT
            ) {
            ...
            if (
              item.audit_status ===
              Core.Const.CRM_AUDIT_PROCESS.AUDIT_STATUS.REFUSE
            ) {

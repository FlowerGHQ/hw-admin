      ...
      <div class="search">
        <a-row class="row-detail">
          ...
          <a-col
            ...
            <div class="value">
              <TimeSearch
                @search="handleOtherSearchPayment"
                ref="TimeSearchPayment" />
            </div>
          </a-col>
          <!-- 退款时间 -->
          <a-col
            ...
            <div class="value">
              <TimeSearch
                @search="handleOtherSearchRefunded"
                ref="TimeSearchRefunded" />
            </div>
          </a-col>
          <a-col
            :xs="24"
  ...
  methods: {
    ...
    addressSelect(data) {
      this.searchForm.to_country =
        this.lang === "zh" ? data?.country?.name : data?.country?.name_en;
      this.searchForm.to_province =
        this.lang === "zh" ? data?.province?.name : data?.province?.name_en;
      this.searchForm.to_city =
        this.lang === "zh" ? data?.city?.name : data?.city?.name_en;
    ...
    handleSearch() {
      // 搜索
      this.pageChange(
        Core.Data.getItem("currPage") ? Core.Data.getItem("currPage") : 1
      );
    },

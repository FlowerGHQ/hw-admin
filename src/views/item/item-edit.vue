<template>
    <div id="ItemEdit" class="edit-container" ref="bigBox">
                ...
                <div class="form-item required">
                    ...
                    <div class="value">
                        <a-input
                            ...
                            @change="handleTableNameChange('zh')"
                ...
                <div class="form-item required">
                    ...
                    <div class="value">
                        <a-input
                            ...
                            @change="handleTableNameChange('en')"
                            :placeholder="$t('def.input')"
                            :maxlength="50"
                        />
                    </div>
                    ...
                    <div class="form-item not-aligin-item">
                        ...
                        <div class="value">
                            ...
                            <a-row gutter="16" class="m-t-16">
                                ...
                                <!-- 高 -->
                                <a-col :xs="24" :sm="8" :xl="8" :xxl="8">
                                    <a-input-number :controls="false" v-model:value="form.height">
                                        <template #addonBefore>
        ...
        <!-- 单规格时的整车价格信息 -->
        <div
            class="labber-form-block form-block"
            v-if="(specific.mode === 1 || indep_flag) && form.type === itemTypeMap['1']?.key"
        >
            <div class="form-title">
                <div class="title">{{ $t('i.price_information') }}</div>
            </div>
            <div class="labber-form-content">
                <div class="key-title">
                    ...
                    <div class="labber">
                        <div class="value input-number">
                            <div :class="!form.fob_40qh_eur && isValidate ? ' title required error' : 'title required'">
                                {{ $t('item-edit.quantity_40HQ') }}
                            </div>
                            <a-input-number
                        ...
                        <div class="value input-number">
                            <div :class="!form.fob_20gp_eur && isValidate ? ' title required error' : 'title required'">
                                {{ $t('item-edit.quantity_20GP') }}
                            </div>
                            <a-input-number
                        ...
                        <div class="value input-number">
                            <div :class="!form.fob_eur && isValidate ? ' title required error' : 'title required'">
                                {{ $t('item-edit.sample') }}
                            </div>
                            <a-input-number
                                v-model:value="form.fob_eur"
                ...
                <div class="key-title">
                    ...
                    <div class="labber">
                        <div class="value input-number">
                            <div :class="!form.fob_40qh_usd && isValidate ? ' title required error' : 'title required'">
                                {{ $t('item-edit.quantity_40HQ') }}
                            </div>
                            <a-input-number
                        ...
                        <div class="value input-number">
                            <div :class="!form.fob_20gp_usd && isValidate ? ' title required error' : 'title required'">
                                {{ $t('item-edit.quantity_20GP') }}
                            </div>
                            <a-input-number
                        ...
                        <div class="value input-number">
                            <div :class="!form.fob_usd && isValidate ? ' title required error' : 'title required'">
                                {{ $t('item-edit.sample') }}
                            </div>
                            <a-input-number
                                v-model:value="form.fob_usd"
        ...
        <div class="form-btns fixed-btns" ref="fixBox" :style="{ width: fixedWidth }">
            <!-- 保存草稿 -->
            <a-button @click="handleSubmit('draft')" v-if="saveDarftShow">
                {{ $t('i.save_draft') }}
            </a-button>
            <!--  type="primary" ghost -->
    ...
    methods: {
        ...
        checkFormInput(form, specData, attrDef) {
            ...
            //单规格并且为整车
                ...
                // 多规格商品 检查
                if (!specData.length) {
                    return this.$message.warning(`${this.$t('i.add_spec_tip')}`);
                }

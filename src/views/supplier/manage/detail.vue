                                            ...
                                            <div
                                                ...
                                                :class="{
                                                    'edit-type-item-select':
                                                        Number(item.value) === Number(parameters.type),
                    ...
                    <div class="information-form">
                        ...
                        <div class="level-search-row">
                            <div class="search-col m-t-0 required align-flex-start">
                                <div class="key w-130 t-a-r text-color" :class="{ 'm-t-4': isEdit }">
                                            ...
                                            <template v-if="column.key === 'position'">
                                                <div class="information-customer-name w-100">
                                                    <span
                                                        v-if="
                                                            text !==
                                                            Core.Const.SUPPLAY.POSITION_MAP_STATUS.GENERAL_MANAGER
                                                        "
                ...
                <div class="information-container-form">
                    ...
                    <div class="information-form">
                        ...
                        <div class="level-search-row">
                            ...
                            <div class="search-col">
                                <div class="key w-130 t-a-r text-color">
                                    {{ $t('supply-chain.parent_company_name') }}
                                </div>
                                <div class="value m-l-8">
                                    <a-input
                                        :class="{ 'customer-input': !isEdit }"
                            ...
                            <div class="search-col">
                                <div class="key w-130 t-a-r text-color">
                                    {{ $t('supply-chain.Parent_company_address') }}
                                </div>
                                <div class="value m-l-8">
                                    <a-input
                                        :class="{ 'customer-input': !isEdit }"
                ...
                >
                    ...
                    <div class="information-form">
                        ...
                        <div class="level-search-row">
                            ...
                            <div class="search-col w-50-percentage">
                                <div class="key w-130 t-a-r text-color">
                                    {{ $t('supply-chain.agency_relationship') }}
                                </div>
                                <div class="value m-l-8">
                                    <a-input
                                        :class="{ 'customer-input': !isEdit }"
                                ...
                                <div class="value m-l-8">
                                    <template v-if="!isEdit">
                                        <a-radio :checked="true">
                                            {{
                                                Core.Const.SUPPLAY.Legal_Dispute[
                                                    msgDetail.agent_info?.flag_agent_warrant
                                                ]
                                                    ? $t(
                                                          Core.Const.SUPPLAY.Legal_Dispute[
                                                              msgDetail.agent_info?.flag_agent_warrant
                ...
                >
                    ...
                    <div class="information-form">
                        <div class="level-search-row">
                            ...
                            <div class="search-col m-t-0">
                                <div class="key w-130 t-a-r text-color">
                                    {{ $t('supply-chain.total_number_of_employees') }}
                                </div>
                                <div class="value m-l-8">
                                    <a-input-number
                                        class="w-100 p-l-0"
                        ...
                        <div class="level-search-row">
                            ...
                            <div class="search-col w-50-percentage technical_seniority">
                                <div class="key w-130 t-a-r text-color">
                                    {{ $t('supply-chain.technical_seniority') }}
                                </div>
                                <div class="value m-l-8">
                                    <a-input
                                        class="w-100 p-l-0"
                                ...
                                <div class="value m-l-8">
                                    <template v-if="!isEdit">
                                        <a-radio :checked="true">
                                            {{
                                                Core.Const.SUPPLAY.Legal_Dispute[
                                                    msgDetail.financial_info?.flag_legal_dispute
                                                ]
                                                    ? $t(
                                                          Core.Const.SUPPLAY.Legal_Dispute[
                                                              msgDetail.financial_info?.flag_legal_dispute
                            ...
                            <div class="search-col">
                                ...
                                <div class="value m-l-8">
                                    <a-input
                                        :class="{ 'customer-input': !isEdit }"
                                        v-model:value="
                                            parameters.financial_info.average_monthly_wage_of_operating_workers
                                        "
                                        :placeholder="
                                            isEdit ? $t('common.please_enter') : $t('supply-chain.no_content')
                                        "
                            ...
                            <div class="search-col">
                                ...
                                <div class="value m-l-8">
                                    <a-input
                                        :class="{ 'customer-input': !isEdit }"
                                        v-model:value="
                                            parameters.financial_info.per_capita_annual_output_value_of_management_staff
                                        "
                                        :placeholder="
                                            isEdit ? $t('common.please_enter') : $t('supply-chain.no_content')
                                        "
                                ...
                                <div class="value m-l-8">
                                    <template v-if="!isEdit">
                                        <a-radio :checked="true">
                                            <template
                                                v-if="
                                                    Number(msgDetail.financial_info?.account_period_requirement) === 0
                                                "
                                            >
                                            ...
                                            <template v-else>
                                                {{
                                                    Core.Const.SUPPLAY.ACCOUNt_PERIOD_REQUIREMENT[
                                    ...
                                    <template v-else>
                                        <a-radio-group
                                            v-model:value="parameters.financial_info.account_period_requirement"
                                        >
                                            <a-radio
                                        ...
                                        <a-radio :checked="true">
                                            <div class="d-fl-a">
                                                <span class="no-white-space m-r-4">
                                                    {{
                                                        Core.Const.SUPPLAY.INVOICE_TYPE[
                                                            msgDetail.financial_info?.invoice_type
                                                        ]
                                                            ? $t(
                                                                  Core.Const.SUPPLAY.INVOICE_TYPE[
                                                                      msgDetail.financial_info?.invoice_type
                                            ...
                                            >
                                                <template v-if="Number(item.value) === 1">
                                                    <div class="d-fl-a">
                                                        ...
                                                        <a-input
                                                            v-model:value="
                                                                parameters.financial_info.invoice_range_value
                                                            "
                                                            :placeholder="
                                                                isEdit
                                                                    ? $t('common.please_enter')
                    ...
                    <div class="information-form">
                        ...
                        <div class="level-search-row">
                            <div class="search-col m-t-0 align-flex-start">
                                <div class="key w-130 t-a-r text-color">
                                    {{ $t('supply-chain.competitor_information') }}
                                </div>
                                        ...
                                        <template #bodyCell="{ column, text, record, index }">
                                            ...
                                            <template v-if="column.key === 'operations' && isEdit">
                                                <a-button
                                                    v-if="index !== 0"
                                                    type="link"
                                                    @click="onDeleate('competitor_delete', record, index)"
                                                >
                                        ...
                                        <template #bodyCell="{ column, text, record, index }">
                                            ...
                                            <template v-if="column.key === 'operations' && isEdit">
                                                <a-button
                                                    v-if="index !== 0"
                                                    type="link"
                                                    @click="onDeleate('customer_information_delete', record, index)"
                                                >
                                                    <i class="icon i_delete" />
                                                    {{ $t('def.delete') }}
                                                </a-button>
                ...
                >
                    ...
                    <div class="information-form">
                        <div class="level-search-row">
                            ...
                            >
                                <div class="key w-130 t-a-r text-color">
                                    {{ $t('supply-chain.research_and_development_center') }}
                                </div>
                                <div class="value m-l-8">
                                    <a-input
                                        :class="{ 'customer-input': !isEdit }"
                        ...
                        >
                            ...
                            <div class="search-col">
                                ...
                                <div class="value m-l-8 d-fl">
                                    <template v-if="!isEdit">
                                        <template
                                            v-for="(item, index) in msgDetail.technical_info?.product_design"
                                            :key="index"
                                        >
                        ...
                        >
                            ...
                            <div class="search-col">
                                ...
                                <div class="value m-l-8 d-fl">
                                    <template v-if="!isEdit">
                                        <template
                                            v-for="(item, index) in msgDetail.technical_info?.process_design"
                                            :key="index"
                                        >
                                            <a-checkbox :checked="true">
                                                {{
                        ...
                        >
                            ...
                            <div class="search-col">
                                <div class="key w-130 t-a-r text-color">
                                    {{ $t('supply-chain.process_verification') }}
                                </div>
                                <div class="value m-l-8 d-fl">
                                    <template v-if="!isEdit">
                                        <template
                                            v-for="(item, index) in msgDetail.technical_info?.process_validation"
                                            :key="index"
                                        >
                                            <a-checkbox :checked="true">
                                                {{
                        ...
                        <template v-if="isMember(parameters.type, [Core.Const.SUPPLAY.SUPPLAY_TYPE_MAP.Mold])">
                            ...
                            <div class="level-search-row">
                                <div class="search-col">
                                    <div class="key w-130 t-a-r text-color">
                                        {{ $t('supply-chain.design_specifications') }}
                                    </div>
                                    <div class="value m-l-8">
                                        <a-input
                                            :class="{ 'customer-input': !isEdit }"
                            ...
                            <div class="level-search-row">
                                <div class="search-col">
                                    <div class="key w-130 t-a-r text-color">
                                        {{ $t('supply-chain.mold_manufacturing') }}
                                    </div>
                                    <div class="value m-l-8">
                                        <a-input
                                            :class="{ 'customer-input': !isEdit }"
                        ...
                        <div class="level-search-row">
                            ...
                            <div class="search-col align-flex-start">
                                <div class="key w-130 t-a-r text-color">
                                    {{ $t('supply-chain.development_process') }}
                                </div>
                                <div class="value m-l-8">
                                    <a-textarea
                                        :class="{ 'customer-input': !isEdit, 'h-64': true }"
                ...
                >
                    ...
                    <div class="information-form">
                        <div class="level-search-row">
                            ...
                            <div class="search-col m-t-0">
                                <div class="key w-130 t-a-r text-color">
                                    {{ $t('supply-chain.quality_system_certification') }}
                                </div>
                                <div class="value m-l-8">
                                    <a-input
                                        :class="{ 'customer-input': !isEdit }"
                            ...
                            <div class="search-col m-t-0">
                                <div class="key w-130 t-a-r text-color">
                                    {{ $t('supply-chain.environmental_system_certification') }}
                                </div>
                                <div class="value m-l-8">
                                    <a-input
                                        :class="{ 'customer-input': !isEdit }"
                        ...
                        <div class="level-search-row">
                            ...
                            <div class="search-col">
                                <div class="key w-130 t-a-r text-color">
                                    {{ $t('supply-chain.quality_cooperation_agency') }}
                                </div>
                                <div class="value m-l-8">
                                    <a-input
                                        :class="{ 'customer-input': !isEdit }"
                            ...
                            <div class="search-col">
                                <div class="key w-130 t-a-r text-color">
                                    {{ $t('supply-chain.accredited_laboratory') }}
                                </div>
                                <div class="value m-l-8">
                                    <a-input
                                        :class="{ 'customer-input': !isEdit }"
                        ...
                        <div class="level-search-row">
                            ...
                            <div class="search-col">
                                <div class="key w-130 t-a-r text-color">
                                    {{ $t('supply-chain.quality_control_tool_software') }}
                                </div>
                                <div class="value m-l-8">
                                    <a-input
                                        :class="{ 'customer-input': !isEdit }"
                            ...
                            <div class="search-col">
                                <div class="key w-130 t-a-r text-color">
                                    {{ $t('supply-chain.planning_system_certification') }}
                                </div>
                                <div class="value m-l-8">
                                    <a-input
                                        :class="{ 'customer-input': !isEdit }"
                ...
                >
                    ...
                    <div class="information-form">
                        <div class="level-search-row">
                            ...
                            <div class="search-col m-t-0 align-flex-start">
                                <div class="key w-130 t-a-r text-color">
                                    {{ $t('supply-chain.qutsourced_technology') }}
                                </div>
                                <div class="value m-l-8">
                                    <a-textarea
                                        :class="{ 'customer-input': !isEdit, 'h-64': true }"
                        ...
                        <div class="level-search-row">
                            ...
                            <div class="search-col align-flex-start">
                                <div class="key w-130 t-a-r text-color">
                                    {{ $t('supply-chain.qutsourced_spare_parts') }}
                                </div>
                                <div class="value m-l-8">
                                    <a-textarea
                                        :class="{ 'customer-input': !isEdit, 'h-64': true }"
                        ...
                        <div class="level-search-row">
                            ...
                            <div class="search-col align-flex-start">
                                <div class="key w-130 t-a-r text-color">
                                    {{ $t('supply-chain.purchased_raw_materials') }}
                                </div>
                                <div class="value m-l-8">
                                    <a-textarea
                                        :class="{ 'customer-input': !isEdit, 'h-64': true }"
                        ...
                        <div class="level-search-row">
                            ...
                            <div class="search-col align-flex-start">
                                <div class="key w-130 t-a-r text-color">
                                    {{ $t('supply-chain.qutsourcing_system') }}
                                </div>
                                <div class="value m-l-8">
                                    <a-textarea
                                        :class="{ 'customer-input': !isEdit, 'h-64': true }"
                                        ...
                                        <template #bodyCell="{ column, text, record, index }">
                                            ...
                                            <template v-if="column.key === 'operations' && isEdit">
                                                <a-button
                                                    v-if="index !== 0"
                                                    type="link"
                                                    @click="onDeleate('key_production_equipment', record, index)"
                                                >
                                                    <i class="icon i_delete" />
                                                    {{ $t('def.delete') }}
                                                </a-button>
                                        ...
                                        <template #bodyCell="{ column, text, record, index }">
                                            ...
                                            <template v-if="column.key === 'operations' && isEdit">
                                                <a-button
                                                    v-if="index !== 0"
                                                    type="link"
                                                    @click="onDeleate('critical_detection_equipment', record, index)"
                                                >
                                                    <i class="icon i_delete" />
                                                    {{ $t('def.delete') }}
                                                </a-button>
                ...
                <div class="information-container-form">
                    ...
                    <div class="information-form">
                        <div class="level-search-row">
                            ...
                            <div class="search-col m-t-0 align-flex-start required">
                                ...
                                <div class="value m-l-8">
                                    <template v-if="!isEdit">
                                        <template
                                            v-for="(item, index) in msgDetail.confirmatory_material
                        ...
                        <div class="level-search-row">
                            ...
                            <div class="search-col required">
                                <div class="key w-130 t-a-r text-color">
                                    {{ $t('supply-chain.registered_capital') }}
                                </div>
                                <div class="value m-l-8">
                                    <a-input
                                        :class="{ 'customer-input': !isEdit }"
                            ...
                            <div class="search-col required">
                                ...
                                <div class="value m-l-8" style="display: flex; align-items: center">
                                    <template v-if="!isEdit">
                                        <a-radio :checked="true">
                                            {{
                                                Core.Const.SUPPLAY.BUSINESS_TERM[
                                                    msgDetail.confirmatory_material?.business_duration_type
                                                ]
                                                    ? $t(
                                                          Core.Const.SUPPLAY.BUSINESS_TERM[
                                                              msgDetail.confirmatory_material?.business_duration_type
                                        ...
                                        <div
                                            ...
                                            v-if="
                                                Number(msgDetail.confirmatory_material?.business_duration_type) ===
                                                Core.Const.SUPPLAY.BUSINESS_TERM_MAP.short_term_validity
                                            "
                                        >
                                            {{
                                    ...
                                    <template v-else>
                                        <a-radio-group
                                            v-model:value="parameters.confirmatory_material.business_duration_type"
                                        >
                                            <a-radio
                                            ...
                                            >
                                                ...
                                                <template v-if="Number(item.value) === 2">
                                                    <TimeSearch
                                                        ...
                                                        v-if="
                                                            Number(
                                                                parameters.confirmatory_material.business_duration_type,
                                                            ) === 2
                                                        "
                                                        :value="[
                ...
                <div class="information-container-form">
                    ...
                    <div class="information-form">
                        <div class="level-search-row">
                            ...
                            <div class="search-col m-t-0 align-flex-start">
                                <div class="key w-130 t-a-r text-color">
                                    {{ $t('supply-chain.bank_account_license') }}
                                </div>
                                <div class="value m-l-8">
                                    <template v-if="!isEdit">
                                        <template
                                            v-for="(item, index) in msgDetail.confirmatory_material
                                                ?.account_opening_bank_license"
                                            :key="index"
                                        >
                                            <img
                                                class="materials-img"
                                    ...
                                    <template v-else>
                                        <MyUpload
                                            ...
                                            :tip="$t('supply-chain.please_upload')"
                                            v-model:value="
                                                parameters.confirmatory_material.account_opening_bank_license
                                            "
                                            showTip
                                            :limit="9"
                                            :limitSize="2"
                        ...
                        <div class="level-search-row">
                            ...
                            <div class="search-col align-flex-start">
                                <div class="key w-130 t-a-r text-color">
                                    {{ $t('supply-chain.environmental_assessment_certificate') }}
                                </div>
                                <div class="value m-l-8">
                                    <template v-if="!isEdit">
                                        <template
                        ...
                        <div class="level-search-row">
                            ...
                            <div class="search-col align-flex-start">
                                <div class="key w-130 t-a-r text-color">
                                    {{ $t('supply-chain.environmental_protection_report') }}
                                </div>
                                <div class="value m-l-8">
                                    <template v-if="!isEdit">
                                        <template
        ...
        <MyMask :isClose="isClose" @close="onPingPongMaskClose">
            <div class="mask-center">
                ...
                <div class="btn">
                    ...
                    <a-button type="primary" @click="onSuction('submit_exit')">{{
                        $t('supply-chain.submit_exit')
                    }}</a-button>
                </div>
            </div>
        </MyMask>
...
const deviceProductionColumns = computed(() => {
    ...
    if (isEdit) {
        columns.push({ title: proxy.$t('common.operations'), key: 'operations' });
    }
...
const competitionColumns = computed(() => {
    let columns = [
        ...
        {
            title: proxy.$t('supply-chain.understanding_evaluation'),
...
const customerInfoColumns = computed(() => {
    let columns = [
        ...
        {
            title: proxy.$t('supply-chain.Start_time'),
    ...
    Core.Api.SUPPLY.adminDetail(obj)
        .then(res => {
            ...
            if (accountOpeningBankLicense) {
                msgDetail.value.confirmatory_material.account_opening_bank_license =
                    accountOpeningBankLicense.split(',');
            }
            // 环评证书
            if (eiaCertificate) {
                ...
                switch (key) {
                    ...
                    case 'customer_info':
                        ...
                        form[key].forEach((el, index) => {
                            // 标准格式
                            el.begin_cooperation_time = dayjs(
                                parameters.value[key][index].begin_cooperation_time,
                            ).unix();
                        });
                        break;

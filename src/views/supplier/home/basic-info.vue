...
<template>
    <div class="edit-container-new-edit padding-20">
        ...
        <a-form
            ...
            <div class="form-block-box padding-0">
                ...
                <div class="form-content-top">
                    <a-radio-group v-model:value="type">
                        <a-radio
                            :value="item.value"
                            v-for="item in Core.Const.SUPPLAY.SUPPLAY_TYPE_LIST"
                            >{{ $t(item.t) }}</a-radio
                        >
                    </a-radio-group>
                </div>
            ...
            <div
                class="form-block-box"
                v-for="($1, ind1) in msgPost"
                :key="ind1 + '$'">
                        ...
                        <div
                            ...
                            <div
                                ...
                                :class="{
                                    required: $3.required,
                                    'on-line': $3?.online,
                                    'on-warp-line': !$3?.online,
                                }"
                                v-for="($3, ind3) in $2.list">
                                <div class="key" v-if="$3.key">
                                    {{ $3.key }}
                                </div>
                                <div
                                    class="value"
                                    :class="{ 'on-line': $3?.online }">
                                    <!--  name="pass" -->
            ...
            <div class="component-box">
                <component ref="allComRef" :is="componentName" :msg="msgPart">
                </component>
            </div>
...
export default defineComponent({
    ...
    setup(props) {
                        ...
                        list: [
                            {
                                key: "员工总数",
                                value: undefined,
                                valueParam: "employees_num_total",
                                type: 3,
                                required: false,
                            },
                            {
...

                    {
                        ...
                        list: [
                            ...
                            },
                            {
                                key: "管理职员人均年产值",
                                value: undefined,
                                valueParam: "employee_avg_work_money",
                                type: 3,
                                required: false,
                            },
                            {
                        ...
                        list: [
                            {
                                key: "业务比重",
                                value: undefined,
                                valueParam: "proportion_business",
                                type: 1,
                                required: false,
                                online: true,
                            },
                            {
                                key: "",
                                value: undefined,
                                valueParam: "proportion_business_obj_year",
                                type: 6,
                                required: false,
                                online: true,
                                objList: [
        ...
        const handleTypeModeChange = (data) => {
            let boo = true;
            if (data.target.value === Core.Const.SUPPLAY.POSITION[4].value)
                boo = false;

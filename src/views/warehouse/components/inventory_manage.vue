            ...
            >
                <template #bodyCell="{ column, text, record }"> 
                    ...
                    <template v-if="column.key === 'operation'">
                        ...
                        <a-button type="link" @click="handleDetailShow(record)" v-if="$auth('agent.detail')"><i class="icon i_detail"/>{{ $t('n.detail') }}</a-button>
                        <a-button type="link" @click="handleDelete(record.id)" v-if="$auth('agent.save')"><i class="icon i_delete"/>{{ $t('def.delete') }}</a-button>
                    </template>
                </template>
            </a-table>
        </div>

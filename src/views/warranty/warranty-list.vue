                    ...
                    <template v-if="tabstatus === 2 || searchForm.target_type !== 1">
                        ...
                        <a-col :xs="24" :sm="24" :xl="8" :xxl="6" class="search-item">
                            ...
                            <div class="value">
                                <a-input
                                    ...
                                    v-model:value="searchForm.item_name"
                        ...
                        <a-col :xs="24" :sm="24" :xl="8" :xxl="6" class="search-item">
                            ...
                            <div class="value">
                                <CategoryTreeSelect
                                    @change="handleSelect"
                                    :category-id="searchForm.target_id"
                                    type="list-item"
                                />
                            </div>
                        </a-col>
                        ...
                        <a-col :xs="24" :sm="24" :xl="8" :xxl="6" class="search-item">
                            ...
                            <div class="value">
                                <a-input
                                    :placeholder="$t('def.input')"
                                    v-model:value="searchForm.item_code"
                                    @keydown.enter="handleSearch"
                                />
                            </div>
                        </a-col>
                ...
                >
                    <template #bodyCell="{ column, text, record }">
                        ...
                        <template v-if="column.dataIndex === 'item_category_name_list'">
                            {{
                                $i18n.locale === 'zh'
                                    ? record?.item_category_name_list
                ...
                >
                    <template #bodyCell="{ column, text, record }">
                        ...
                        <template v-if="column.key === 'category_name_list'">
                            {{
                                ($i18n.locale === 'zh' ? record?.category_name_list : record?.category_name_list_en) ||
                                '-'
                            }}
                        </template>
                    ...
                    <div class="form-item required">
                        ...
                        <div class="value">
                            ...
                            <a-input-number
                                ...
                                :max="20000"
                                :precision="0"
                                v-model:value="editForm.mileage"
                                :placeholder="$t(/*请输入*/ 'def.input')"
                            />
                            {{ $t(/*公里*/ 'r.km') }}
                        </div>
...
export default {
    ...
    methods: {
        ...
        getCategoryTableData() {
            this.loading = true;
            Core.Api.Warranty.categoryList()
                .then(res => {
            ...
            Core.Api.Warranty.itemList({
                ...
                .then(res => {
                    ...
                    this.itemTableData.forEach(el => {
                        el.item_category_name_list = el.item_category_name_list.length
                            ? el.item_category_name_list.join('/')
                            : '-';
                        el.item_category_name_en_list = el.item_category_name_en_list.length
                            ? el.item_category_name_en_list.join('/')
                            : '-';
                    });
                })
                .catch(err => {

    ...
    <div id="WarrantyList">
        <div class="list-container">
            ...
            <div class="tabs-container colorful">
                <a-tabs v-model:activeKey="searchForm.status" @change='handleTabSearch(1)'>
            ...
            <div class="search-container" v-if="searchForm.status !== 1">
                <a-row class="search-area">
                    ...
                    <!-- 商品名称 -->
                    <a-col :xs='24' :sm='24' :xl="8" :xxl='6' class="search-item" v-if="searchForm.status === 2">
                        <div class="key">{{ $t('r.item_name') }}:</div>
                        <div class="value">
                            <a-input :placeholder="$t('def.input')" v-model:value="searchForm.item_name"
                                @keydown.enter='handleSearch' />
                    ...
                    <a-col :xs='24' :sm='24' :xl="8" :xxl='6' class="search-item" v-if="searchForm.status !== 1">
                        ...
                        <div class="value">
                            <CategoryTreeSelect @change="handleSelect" :category-id="searchForm.target_id" />
                        </div>
                    </a-col>
                    <!-- 商品编码 -->
                    <a-col :xs='24' :sm='24' :xl="8" :xxl='6' class="search-item"
...
export default {
    ...
    computed: {
        categoryTableColumns() {
            let columns = [
                { title: this.$t('i.categories'), dataIndex: 'category_name', key: 'item' },
        ...
        itemTableColumns() {
            let columns = [
                ...
                { title: this.$t('i.categories'), dataIndex: 'item_category_name_list' },
        ...
        trackTableColumns() {
            ...
            if (this.searchForm.type === 2) {
                columns.splice(1, 0,
                    { title: this.$t('i.categories'), dataIndex: 'item_name', key: 'item' },
                    { title: this.$t('i.code'), dataIndex: 'item_code', key: 'item' }
                )
            }
            return columns

    ...
    <div id="mall-header">
        ...
        <div id="menu">
            <div class="menu-content content">
                ...
                <!-- 配件 -->
                <span class="menu-item" @click="routerChange('/mall/accessories-list')">
                ...
                <!-- 周边产品 -->
                <span class="menu-item" @click="routerChange('/mall/peripheral-list')">
                    <span class="menu-item-text tab-animate" :class="car_type_index === 2 ? 'active' : ''">{{ $t('mall.peripheral_products') }}</span>
                </span>
                <!-- 广宣品 -->
                <span class="menu-item" @click="routerChange('/mall/promotional-list')">

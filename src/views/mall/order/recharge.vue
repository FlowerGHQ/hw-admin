                    ...
                    <div class="steps-content">
                        ...
                        <template v-if="current === 0">
                            ...
                            >
                                ...
                                >
                                    <a-input v-model:value="formState.price" suffix="€" />
                                </a-form-item>
                                <a-form-item
                                    label="Price2"
                                    name="price2"
                                ...
                                >
                                    <a-input v-model:value="formState.price2" suffix="€" />
                                </a-form-item>
                            </a-form>
                            <div class="deposit-payment">
                                <div class="deposit-payment-row title">
                                    <span class="deposit-payment-row-left">
                                        <span class="payment-bank-body">
                                            <svg-icon
                                                icon-class="payment_bank"
                                                class="svg-icon"
                                                :style="{ fontSize: '28px' }"
                                            />
                                        </span>
                                    ...
                                    <span class="deposit-payment-row-right">
                                        Copy Payment Account Information&nbsp;
                                        <svg-icon
                                            icon-class="payment_copy"
                                            class="svg-icon"
                                            :style="{ fontSize: '14px' }"
                                            @click="TestCopyBox('deposit-payment')"
                                        />
                                    </span>
                                </div>
                            </div>
                            <div class="deposit-payment" id="deposit-payment">
                                <div class="deposit-payment-row">
                                    <span class="deposit-payment-row-left">Account Holder</span>
                                    <span class="deposit-payment-row-right">{{ accout.accountHolder }}</span>
                                </div>
                                <div class="deposit-payment-row">
                                    <span class="deposit-payment-row-left">Account Nickname</span>
                                    <span class="deposit-payment-row-right">{{ accout.accountNickname }}</span>
                                </div>
                                <div class="deposit-payment-row">
                                    <span class="deposit-payment-row-left">IBAN</span>
                                    <span class="deposit-payment-row-right">{{ accout.IBAN }}</span>
                                </div>
                                <div class="deposit-payment-row">
                                    <span class="deposit-payment-row-left">SWIFT/BIC</span>
                                    <span class="deposit-payment-row-right">{{ accout.SWIFTBIC }}</span>
                                </div>
                                <div class="deposit-payment-row">
                                    <span class="deposit-payment-row-left">Bank name</span>
                                    <span class="deposit-payment-row-right">{{ accout.bankName }}</span>
                                </div>
                                <div class="deposit-payment-row">
                                    <span class="deposit-payment-row-left">Bank address</span>
                                    <span class="deposit-payment-row-right">{{ accout.bankAddress }}</span>
                                </div>
                            </div>
                        </template>
                        <!-- 第二步 -->

		...
		<div class="form-block">
			...
			<div class="form-content">
				...
				<div class="form-item required">
					...
					<div class="value"><a-input-number v-model:value="form.pack_count" :placeholder="$t('n.enter')" />{{ $t('m.pcs') }}</div>
				</div>
				<div class="form-item">
				...
				<div class="form-item">
					...
					<div class="value"><a-input-number v-model:value="gross_weight" :placeholder="$t('n.enter')" style="width: 80px" :min="0" :precision="2" /> kg</div>
				</div>
				<div class="form-item">
					<div class="key">{{ $t('m.weight') }}</div>
					<div class="value">

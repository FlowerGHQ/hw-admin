    ...
    <div id="MaterialPutStock" class="edit-container">
        ...
        <div class="form-block">
            ...
            <div class="form-content">
                ...
                <div class="form-item required">
                    <div class="key">{{ $t('in.inbound_o') }}</div>
                    <div class="value">
                ...
                <div class="form-item">
                    <div class="key">{{ $t('wa.need_amount') }}</div>
                    <div class="value">
                        <a-input type="number" v-model:value="form.amount" disabled />
                    </div>
                </div>
                <div class="form-item">
                    <div class="key">{{ $t('wa.inbounded') }}</div>
                    <div class="value">
                ...
                <div>
                    ...
                    <div class="form-item">
                        <div class="key">{{ $t('wa.inbound') }}</div>
                        <div class="value">
    ...
    methods: {
        ...
        handleSearch() {
            ...
            Core.Api.Item.detailByCode({ code: codeName }).then(res => {
                ...
                console.log('check');
                Core.Api.WarehouseLocationStock.check({

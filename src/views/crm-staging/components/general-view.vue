        ...
        <div class="general-view-item">
            ...
            <div class="content">
                <div class="content-item">
                    <p class="content-item-num">{{ userMes.pre_order_statistics ? userMes.pre_order_statistics.wait_pay_count : 0 }}</p>
                    <p class="content-item-name">待支付</p>
                </div>
                <div class="content-item">
                    <p class="content-item-num">{{ userMes.pre_order_statistics ? userMes.pre_order_statistics.cancel_count : 0 }}</p>
                    <p class="content-item-name">已取消</p>
                </div>
                <div class="content-item">
                    <p class="content-item-num">{{ userMes.pre_order_statistics ? userMes.pre_order_statistics.pay_count : 0 }}</p>
                    <p class="content-item-name">已支付</p>
                </div>
                <div class="content-item">
                    <p class="content-item-num">{{ userMes.pre_order_statistics ? userMes.pre_order_statistics.refund_count : 0 }}</p>
        ...
        <div class="general-view-item">
            ...
            <div class="content">
                ...
                <div class="drive-label">
                    <my-tag :border="true" :borderColor="Static.STATUS_MAP[dirveData.status]?.borderColor" :color="Static.STATUS_MAP[dirveData.status]?.color" bgColor="#FFF">{{ Static.STATUS_MAP[dirveData.status]?.key }}</my-tag>
                </div>
            </div>
        </div>
    </div>

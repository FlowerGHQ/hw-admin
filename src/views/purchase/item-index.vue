  ...
  <div id="ItemIndex">
    <a-spin :spinning="tabLoading">
      <div class="item-header-container">
        <a-tabs
          v-model:activeKey="firstLevelId"
          ...
          <template #rightExtra>
            <a-input-group compact>
              <a-select v-model:value="searchType" class="search_select">
                <a-select-option
                  v-for="(val, key) in SEARCH_TYPE_MAP"
                  :key="key"
                  :value="key"
              ...
              <a-input
                ...
                <template #prefix
                  ><i class="icon i_search" @click="handleSearch"
                /></template>
            ...
            <a-tooltip :title="$t('i.data_export')" class="popover">
              <a-button type="text" @click="handleExportConfirm"
            ...
            <a-popover
              ...
              <template #content>
                <div
                  class="shop-cart-brief"
                  :class="briefVisible ? 'show' : 'hidden'">
                  ...
                  <div class="btns">
                    <a-button
                      class="btn ghost"
                      @click="routerChange('shop_cart')"
                      >{{ $t("i.look") }}({{ briefCount }})</a-button
                    >
                    <a-button
                      class="btn black"
                      @click="routerChange('settle')"
                      >{{ $t("i.settle") }}</a-button
                    >
                  </div>
                </div>
              ...
              <a-tooltip
                :title="
                  $t('i.look') + `${briefCount ? '(' + briefCount + ')' : ''}`
                "
                class="popover">

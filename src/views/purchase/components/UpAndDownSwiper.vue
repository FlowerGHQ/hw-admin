    ...
    <div class="swiper-container">
      <div class="swiper-wrapper">
        <div class="swiper-slide" v-for="item,index in imgs" :key="index">
          <img :src="item" @click="changeIndex(index)" />
        </div>
      </div>

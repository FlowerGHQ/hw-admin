        ...
        <a-row class="panel-content info-container">
            <a-col :xs='24' :sm='24' :lg='12' :xl='8' :xxl='6' class="info-block">
                ...
                <div class="info-item">
                    ...
                    <div class="value" v-if="detail.receive_info">{{detail.receive_info.country + detail.receive_info.province + detail.receive_info.city + detail.receive_info.county + detail.receive_info.address || '-'}}</div>
                    <div class="value" v-else>-</div>
                </div>
            </a-col>
            <a-col :xs='24' :sm='24' :lg='12' :xl='16' :xxl='12' class="info-block">
                ...
                <div class="info-item">
                    ...
                    <div class="value">
                        <WaybillShow v-if="detail.status == REPAIR.STATUS.WAIT_REPAIR" @change="getWaybillDetail" :detail='waybill' :list='waybillInfo.list' :id="id" />

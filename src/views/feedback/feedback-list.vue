    ...
    computed: {
        ...
        statusList() {
            let columns = [
                ...
                {zh: '等待反馈',en: 'Waiting for the feedback', value: '0', color: 'purple',  key: STATUS.WAIT_QUALITY_AUDIT },
                {zh: '待修改',en: 'To modify the', value: '0', color: 'purple',  key: STATUS.QUALITY_AUDIT_FAIL },
                {zh: '等待审核反馈', en: 'Waiting for review feedback', value: '0', color: 'green',  key: STATUS.WAIT_FEEDBACK},
                {zh: '反馈待修改', en: 'Feedback to be modified', value: '0', color: 'green',  key: STATUS.QUALITY_AUDIT_FAIL},

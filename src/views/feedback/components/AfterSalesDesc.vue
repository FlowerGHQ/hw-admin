...
<div class="Feedback">
    <a-collapse v-model:activeKey="activeKey" ghost expand-icon-position="right">
        ...
        <a-collapse-panel key="feedback" :header="$t('fe.after_sales_desc')" class="gray-collapse-panel">
            <div class="panel-content">
                <div class="form-item textarea">
                    <div class="key">{{ $t('fe.after_sales_desc') }}:</div>
                    <div class="value">
                        <a-textarea v-model:value="detail.after_sales_fault_desc"

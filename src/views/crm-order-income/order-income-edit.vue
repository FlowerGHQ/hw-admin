    ...
    <div id="OrderIncomeEdit" class="edit-container" :class="$i18n.locale">
        ...
        <div class="form-block">
            ...
            <div class="form-content key130">
                ...
                <div class="form-item required">
                    <div class="key">{{ $t('crm_oi.belong_order') }}：</div>
                    <!-- 所属客户 -->
                    <div class="value">
                        <a-select
                ...
                <div class="form-item required">
                    ...
                    <div class="value">
                        <a-select v-model:value="form.payment_type" :placeholder="$t('def.select')">
                            <a-select-option v-for="item of CRM_PAYMENT_TYPE" :key="item.value" :value="item.value">{{
                ...
                <div class="form-item required">
                    ...
                    <div class="value">
                        <a-select v-model:value="form.type" :placeholder="$t('def.select')">
                            <a-select-option v-for="item of CRM_TYPE" :key="item.value" :value="item.value">{{
                                lang === 'zh' ? item.zh : item.en
                            }}</a-select-option>
                        </a-select>
                    </div>
                ...
                <div class="form-item">
                    <div class="key">{{ $t('crm_oi.remark') }}：</div>
                    <!-- 备注 -->
                    <div class="value">
                ...
                <div class="form-item textarea">
                    ...
                    <div class="value">
                        <LabelSelect
                            :btnText="$t('sl.add')"
                            :category="Core.Const.CRM_LABEL.CATEGORY.ORDER_INCOME"
                ...
                <div class="form-item required">
                    ...
                    <div class="value">
                        <AuditUser
                            ...
                            :group-id="order_detail.group_id"
        ...
        <div class="form-btns">
            <a-button @click="handleSubmit" type="primary" v-if="$auth('crm-order-income.save')">{{
                $t('def.sure')
            }}</a-button>

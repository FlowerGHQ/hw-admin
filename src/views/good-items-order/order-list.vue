    ...
    <div id="OrderList">
        <div class="list-container">
            <div class="title-container">
                ...
                <div class="but-box">
                      <a-button type="primary" @click="handleExportConfirm" v-if="activeKey===Core.Const.GOODITEMORDER.Order_Status_Map['1'].value" >导出表格</a-button>
...
const handleExportConfirm = () => { // 确认物料是否导出
            proxy.$confirm({
...
const handleMaterialExport = () => { // 物料导出
...
const handleMaterialFormwork = () => { // 下载模板
           /*  let form = Core.Util.deepCopy(this.searchForm);
                for (const key in form) {
                    form[key] = form[key] || ''
                }

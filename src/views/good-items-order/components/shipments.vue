    ...
    <a-button type="link" @click="isShowShip('ship')">
     ...
     <a-modal v-model:visible="isShow" :title="$t(/* 发货 */'p.ship')" >
       ...
       <div class="content">
            <div class="text-warn">
                <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M7.00033 12.3333C9.94584 12.3333 12.3337 9.94548 12.3337 6.99996C12.3337 4.05444 9.94585 1.66663 7.00033 1.66663C4.05481 1.66663 1.66699 4.05444 1.66699 6.99996C1.66699 9.94548 4.05481 12.3333 7.00033 12.3333ZM13.667 6.99996C13.667 10.6819 10.6822 13.6666 7.00033 13.6666C3.31843 13.6666 0.333658 10.6819 0.333659 6.99996C0.333659 3.31806 3.31843 0.333291 7.00033 0.333291C10.6822 0.333292 13.667 3.31806 13.667 6.99996ZM6.33366 10.3333L6.33366 8.99994L7.66699 8.99994L7.66699 10.3333L6.33366 10.3333ZM7.66699 3.66661L7.66699 8.33327L6.33366 8.33327L6.33366 3.66661L7.66699 3.66661Z" fill="#F77234"/>
                </svg>
      ...
      <template #footer>
        ...
        <a-button type="primary" @click="shipHandleOk" >
            提交
        </a-button>
      </template>
    </a-modal>

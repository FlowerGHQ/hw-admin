    ...
    <div class="InformationInfo gray-panel no-margin">
        ...
        <div class="panel-content">
            <a-descriptions :title="$t('crm_c.information')" bordered :column="2" size="small" class="pannel">
                ...
                <a-descriptions-item :label="$t('crm_b.money')" class="label">{{
                    $Util.countFilter(detail.money)
                }}</a-descriptions-item>
                <a-descriptions-item :label="$t('crm_b.status')" class="label">{{
                    currentStepText
                }}</a-descriptions-item>
                <a-descriptions-item :label="$t('crm_b.estimated_deal_time')" class="label">{{
                    $Util.timeFilter(detail.estimated_deal_time, 3)
                }}</a-descriptions-item>
                <a-descriptions-item :label="$t('crm_b.source')" class="label">{{
                    $Util.CRMBoSourceMapFilter(detail.source, $i18n.locale)
                }}</a-descriptions-item>

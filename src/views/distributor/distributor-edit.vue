  ...
  <div id="DistributorEdit" class="edit-container">
    ...
    <div class="form-block">
      ...
      <div class="form-content">
        ...
        <div class="form-item required">
          ...
          <div class="value">
            <a-select
              ...
              :placeholder="$t('def.select_payment_term')">
              <a-select-option
        ...
        <div class="form-item">
          ...
          <div class="value">
            <a-input
              v-model:value="form.receive_port"
              :placeholder="$t('d.receipt')" />
          </div>
        </div>
        <div class="form-item">
          ...
          <div class="value">
            <div class="value">
              <a-radio-group v-model:value="form.flag_stock_change_use_pda">
                <a-radio :value="Core.Const.FLAG.YES">{{
                  $t("i.yes")
                }}</a-radio>
    ...
    <div class="form-btns">
      <a-button
        @click="handleSubmit"
        type="primary"
        v-if="$auth('distributor.save')"
        >{{ $t("def.sure") }}</a-button
      >
      <a-button @click="routerChange('back')" type="primary" ghost="">{{
        $t("def.cancel")
      }}</a-button>
    </div>
  </div>

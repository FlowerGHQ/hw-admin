        ...
        <div class="form-block">
            ...
            <div class="form-content">
                ...
                <div class="form-item required">
                    ...
                    <div class="value">
                        <a-select v-model:value="form.phone_country_code" :placeholder="$t('def.input')" @select="setPhoneCountryCode"  :disabled="form.id > 0 && detail.phone_country_code != ''" show-search option-filter-prop="key" allow-clear>
                ...
                <div class="form-item required with-btn" >
                    ...
                    <div class="value">
                        <a-input v-model:value="form.phone" :placeholder="$t('def.input')" @blur="handleCustomerPhoneBlur" :disabled="(form.id > 0 && detail.phone != undefined)"/>
                        <div class="btn">

<template>
  <div class="CRMTrackRecord gray-panel no-margin">
    ...
    <div class="panel-content">
      <div>
        <SimpleImageEmpty
          :desc="$t('crm_t.track_record_null')"
            ...
            <div class="day-item">
              <div class="panel">
                <div class="top">
                  ...
                  <span
                    class="item-time"
                    v-if="item.create_user_id === user.id"
                  >
                    <FollowUpShow
                      btnType="link"
                      :targetId="targetId"
                      ...
                      ><i class="icon i_edit"
                    /></FollowUpShow>
                    <a class="button" @click="handleDelete(item.id)"
                ...
                <a-row>
                  ...
                  >
                    <div class="content">
                      ...
                      <div class="line">
                        {{ $Util.CRMTrackRecordIntentFilter(item.intent) }}
                      </div>
                    </div>
                  </a-col>
                  <!-- 联系人 -->
                  ...
                  >
                    <div class="content">
                      <div class="line grey">
                        {{ $t("crm_t.next_track_time") }}:
                      </div>
                      <div class="line">
                        {{ $Util.timeFilter(item.next_track_time) }}
                      </div>
                    </div>
                  </a-col>
                  <!-- 下次跟进计划 -->
                ...
                <!-- 内容照片 -->
                <div
                  v-if="item.image_attachment_list.length !== 0"
                  class="content"
                >
                ...
                <!-- 附件 -->
                <div
                  v-if="item.file_attachment_list.length !== 0"
                  class="content"
                >
                ...
                <!-- 跟进人 -->
                <div v-if="item.create_user_name" class="foot">
                  <div class="line">
